...
const SuggestFilm = lazy(()=> import('./pages/Public/SuggestFilm/SuggestFilm'))
// Register - Login
 const NewsFeed = lazy(() => import('./pages/Public/MoviesFeed'));
...
const Feed = lazy(()=> import('./pages/Public/Feed')) ; 
