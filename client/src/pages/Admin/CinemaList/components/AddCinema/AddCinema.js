...
class AddCinema extends Component {
          ...
          seats.map((seat, index) => (
            <div key={`seat-${index}-${seat.length}`} className={classes.field}>
              <TextField
                ...
                label={
                  'Ajouter nombre de chaises pour une ligne : ' +
  ...
  render() {
    ...
    const mainTitle = this.props.editCinema ? 'Editer salle de Cinema' : 'Ajouter salle Cinema';
    const submitButton = this.props.editCinema
      ? 'Mise a jour salle de Cinema'
      : 'Sauvgarder les Detailes';
      ...
      <div className={rootClassName}>
        ...
        <form autoComplete="off" noValidate>
          <div className={classes.field}>
            <TextField
              className={classes.textField}
              helperText="veuiller specifier le nom du salle de cinema"
              label="Nom"
              margin="dense"
              required
              value={name}
