...
class AddMovie extends Component {
  ...
  render() {
    ...
    const subtitle = this.props.edit ? 'Editer Film' : 'Ajouter Film';
    const submitButton = this.props.edit ? 'Mettre a jour ' : 'Sauvgarder Details';
        ...
        <form autoComplete="off" noValidate>
          <div className={classes.field}>
            <TextField
              ...
              helperText="Veuillez specifier le nom du film"
              label="Titre"
              margin="dense"
              required
              value={title}
          ...
          <div className={classes.field}>
            <TextField
              className={classes.textField}
              helperText="Veuillez specifier le ID trailer  du film"
              label="id du trailer on YouTube"
              margin="dense"
              required
              value={youtubeid}
              variant="outlined"
              onChange={event =>
                this.handleFieldChange('youtubeid', event.target.value)
              }
            />
          </div>
          <div className={classes.field}>
          ...
          <div className={classes.field}>
            <MuiPickersUtilsProvider utils={MomentUtils}>
              <KeyboardDatePicker
                ...
                margin="normal"
                id="release-date"
                label="Date de debut de projection"
                value={releaseDate}
                onChange={date =>
                  this.handleFieldChange('releaseDate', date._d)
                }
                KeyboardButtonProps={{
                  'aria-label': 'Date debut de projection'
                }}
              />
              ...
              <KeyboardDatePicker
                ...
                margin="normal"
                id="end-date"
                label="Date fin de projection "
                value={endDate}
                onChange={date => this.handleFieldChange('endDate', date._d)}
                KeyboardButtonProps={{
                  'aria-label': 'Date fin de pojection'
                }}
              />
            </MuiPickersUtilsProvider>
          </div>
