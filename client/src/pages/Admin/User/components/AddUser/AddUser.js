...
class AddUser extends Component {
  ...
  render() {
    ...
    const title = selectedUser ? 'Editer utilisateur' : 'Ajouter utilisateur';
    const submitButton = selectedUser ? 'Mettre a jour utilisateur' : 'Ajouter utilisateur';
        ...
        <form autoComplete="off" noValidate>
          <div className={classes.field}>
            <TextField
              ...
              helperText="Veuillez specifier votre nom "
              label="Nom complet"
              margin="dense"
              required
              value={name}
          ...
          <div className={classes.field}>
            ...
            <TextField
              ...
              select
              className={classes.textField}
              helperText="Admin or utilisateur"
              label="Role"
              margin="dense"
              required
              value={role}
